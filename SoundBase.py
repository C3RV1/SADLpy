...
class SoundBase:
    ...
    @staticmethod
    def read_wav(file_in: str) -> WAV.sWAV:
        wav = WAV.sWAV()
        ...
        if wav.wave.fmt.audio_format != WAV.WaveFormat.WAVE_FORMAT_PCM:
            raise NotImplementedError()

        if wav.wave.fmt.audio_format == WAV.WaveFormat.WAVE_FORMAT_PCM and wav.wave.fmt.bits_per_sample == 0x08:
            ...
            wav.wave.data.data = Compression.PCM.PCM.pcm8unsigned_to_pcm16(wav.wave.data.data)
